...
A delivery date is a forecast built from real capacity, sized so a normal week can carry it. This is where the steward honors webs's thesis (more money, fewer hours, more life) instead of fighting it:
...
- **Divide by real, sustainable capacity,** the hours webs actually has for this product in a normal week alongside everything else she runs. webs's founder-rhythm sense of enough is the input here: the date has to fit inside a week she can repeat without grinding.
